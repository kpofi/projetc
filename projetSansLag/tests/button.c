...
{
    // Exemple pour détruire le bouton lors du clic
	// ei_widget_destroy(widget);
    
	// Des exemples pour n'autoriser le clic du bouton qu'une seule fois, tous les codes suivants sont équivalents
    
    //ei_unbind(ei_ev_mouse_buttondown,	NULL, "all", button_press, NULL);
    //ei_unbind(ei_ev_mouse_buttondown,	NULL, "button", button_press, NULL);
    //ei_unbind(ei_ev_mouse_buttondown,widget, NULL, button_press, NULL);
...
int ei_main(int argc, char** argv)
{
	...
	// Pour tester fonctionnalité all
    ei_bind(ei_ev_mouse_buttondown,		NULL, "all", button_callback, NULL);
