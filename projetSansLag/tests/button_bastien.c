...
int ei_main(int argc, char** argv)
{
	...
	ei_bind(ei_ev_keydown,ei_app_root_widget(), NULL, process_key, NULL);
    
    // MARCHE
	//ei_bind(ei_ev_mouse_buttondown,button, NULL, button_press, NULL);
	...
	//ei_unbind(ei_ev_keydown,	NULL, "all", process_key, NULL); ca c'est l'originale
	//ei_unbind(ei_ev_keydown, ei_app_root_widget(), NULL, process_key, NULL);
	ei_app_free();
